...
async function getHtmlRows() {
    ...
    return todoItems.map(item => `
        <tr>
            <td>${item.id}</td>
            <td>
                <span class="item-text" id="text-${item.id}">${item.text}</span>
                <input type="text" class="edit-input" id="input-${item.id}" value="${item.text}" style="display: none;">
            </td>
            <td>
                <button onclick="removeItem(${item.id})">Remove</button>
                <button onclick="startEdit(${item.id})" class="edit-btn">Edit</button>
                <button onclick="saveEdit(${item.id})" class="save-btn" style="display: none;">Save</button>
            </td>
        </tr>
    `).join('');
}
